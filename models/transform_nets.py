...
def input_transform_net(edge_feature, locals_max_transform, is_training, bn_decay=None, K=3, is_dist=False):
  ...
  net = tf_util.conv2d(tf.concat([net, locals_max_transform], axis=-1), 1024, [1,1],
             padding='VALID', stride=[1,1],
             bn=True, is_training=is_training,
